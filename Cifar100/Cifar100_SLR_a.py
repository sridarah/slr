...
#act_fc1 = Model(input=cifar100_model.input, output=cifar100_model.get_layer('flatten_3').output)
#act_fc2 = Model(input=cifar100_model.input, output=cifar100_model.get_layer('dense_5').output)

# FC7 Layer Number
act_fc1 = Model(input=cifar100_model.input, output=cifar100_model.get_layer('dropout_31').output)
act_fc2 = Model(input=cifar100_model.input, output=cifar100_model.get_layer('dense_6').output)
