...
#act_fc1 = Model(input=vgg19_model.input, output=vgg19_model.get_layer('flatten').output)
#act_fc2 = Model(input=vgg19_model.input, output=vgg19_model.get_layer('fc1').output)

# FC7 Layer Number

act_fc1 = Model(input=vgg19_model.input, output=vgg19_model.get_layer('fc1').output)
act_fc2 = Model(input=vgg19_model.input, output=vgg19_model.get_layer('fc2').output)
